...
import { isFlightFull } from '@/mocks/flightSeatsAvailability'; // Nueva importación
...
const FlightSearchPage = () => {
	...
	const handleSelectFlight = (flight: Flight) => {
		// No permitir selección si el vuelo está completo
		if (isFlightFull(flight.id)) {
			return;
		}
		...
		<div className="min-h-screen bg-gray-50 py-8">
			<div className="max-w-4xl mx-auto px-4">
				...
				<div className="space-y-4">
					{mockFlights.slice(0, 6).map((flight) => {
						const isFull = isFlightFull(flight.id); // Verificar si está completo
						return (
